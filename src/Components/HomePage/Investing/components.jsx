...
import InvestLines from '../../../assets/VectorLineInvest.svg'
import PhoneStock from '../../../assets/investing-stocks.png'
import PhoneBit from '../../../assets/investing-bitcoin.svg'
import InvestGraph from '../../../assets/investing-graph-1.svg'
import InvestGraph2 from '../../../assets/investing-graph-2.svg'
import InvestFloor1 from '../../../assets/investing-floor 1.svg'
import InvestFloor2 from '../../../assets/investing-floor-mobile.png'
const Investing = () => {
  return (
    ...
    <div className='absolute w-[100%] mob:!h-[100%] mob:top-[2%] revsmlap:top-[50%] left-[50%] -translate-x-[50%] revsmlap:-translate-y-[60%] smlap:top-[3%] flex flex-col gap-16 smlap:gap-12 mob:!gap-5 items-center z-50 mob:!justify-center'>
      <h1 style={{fontWeight:"800",fontSize:"40px"}} className=' mob:text-xl font-Agrandir text-white'>
        Investing
      </h1>
      <div className='mob:w-[86dvw] flex flex-row gap-20 smlap:gap-10 mob:!h-full items-center mob:!flex-col mob:!h-full mob:!justify-evenly mob:!pb-7'>
        <div className='flex flex-row gap-8 justify-center items-center smlap:flex-row-reverse mob:!flex-col-reverse mob:!gap-6'>
          <div className='revsmlap:-translate-y-[50%]'>
            <h1 style={{"fontFamily":"Agrandir",fontWeight:"800",fontSize:"22px"}} className='text-xl text-black font-Agrandir mob:!text-[16px]'>
              Stocks
            </h1>
            <p  style={{"fontFamily":"Mulish",fontWeight:"400",fontSize:"16px",letterSpacing:"0.3 px"}}className='revsmlap:w-[350px] mob:!w-[86dvw] text-black font-Mulish mob:text-sm smlap:w-[300px]'>
